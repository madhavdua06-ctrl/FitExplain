...
INSERT INTO "new_Topic" ("category", "createdAt", "id", "order", "scientificContent", "shortDescription", "simpleContent", "slug", "sources", "title", "updatedAt") SELECT "category", "createdAt", "id", "order", "scientificContent", "shortDescription", "simpleContent", "slug", "sources", "title", "updatedAt" FROM "Topic";
DROP TABLE "Topic";
