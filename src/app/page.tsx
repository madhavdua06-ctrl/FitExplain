  ...
  return (
    <div>
      <div className="relative overflow-hidden">
        <div
          className="pointer-events-none absolute -top-32 left-1/2 h-96 w-[42rem] -translate-x-1/2 rounded-full bg-gradient-to-br from-emerald-300 to-teal-300 opacity-25 blur-3xl dark:from-emerald-700 dark:to-teal-800 dark:opacity-20"
          aria-hidden
        />
        <div className="relative mx-auto max-w-3xl px-4 pt-16 pb-8 sm:pt-24">
          <div className="text-center">
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              <Link
                href="/signup"
                className="group inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm shadow-emerald-600/20 transition hover:bg-emerald-700"
              >
                Get your plan
